...
public class LanguageTest {
	...
	public void test() throws URISyntaxException {
		...
		languageManager = new LanguageManager(new UnitTestCaller(), new File(ConfigurationTest.class.getProtectionDomain().getCodeSource().getLocation().toURI()), "languageTest.yml");
		assertEquals("this is a test", languageManager.parse("test", null));
